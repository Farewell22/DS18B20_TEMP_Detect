...
/* USER CODE BEGIN PFP */
MultiTimer test_timer;
void TimertestCallback(MultiTimer* timer, void *userData)
{
  printf("test timer\r\n");
  multiTimerStart(&test_timer,1000,TimertestCallback,NULL);
}
